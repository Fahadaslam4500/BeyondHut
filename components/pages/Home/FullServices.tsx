    ...
    <div className='bg-[#F6F6F6] py-10 my-10'>
        <div className='container'>
            <div className='flex flex-col justify-center items-center gap-2'>
                ...
                <h2 className="font-dm_serif text-2xl md:text-4xl font-thin text-center">Full service.</h2>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-3'>
                    <div className='bg-white min-h-[250px] flex flex-col min-w-[250px] p-5 rounded-xl border-4 border-[#C6C6C6]'>
                        <h4 className='text-xl font-dm_serif mb-4'>Recruiters</h4>
                    ...
                    <div className='bg-white min-h-[250px] flex flex-col min-w-[250px] p-5 rounded-xl border-4 border-[#C6C6C6]'>
                        <h4 className='text-xl font-dm_serif mb-4'>Staffing Firms</h4>
                        <ul className='text-[#616161] flex flex-col justify-start items-start gap-2'>
                    ...
                    <div className='bg-white min-h-[250px] flex flex-col min-w-[250px] p-5 rounded-xl border-4 border-[#C6C6C6]'>
                        <h4 className='text-xl font-dm_serif mb-4'>Job Boards</h4>
                        <ul className='text-[#616161] flex flex-col justify-start items-start gap-2'>
