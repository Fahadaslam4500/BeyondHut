            ...
            <div className='relative  max-lg:min-h-[50vh] min-h-[450px] p-5  flex flex-col justify-center items-center md:rounded-[50px] rounded-[30px] overflow-visible'>
                ...
                <div className='flex flex-col justify-center items-center w-full relative z-[20]'>
                    <div className='w-full mt-14 mb-10 flex flex-col gap-3'>
                            <h2 className="fade-in-up font-roca text-2xl text-center md:text-[40px] font-thin mb-3">Ready to Stop Drowning in Calls?</h2>
                ...
                <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
                    <div className="relative w-full h-full animate-glow-top">
                        <div className="absolute md:w-[400px] md:h-[300px] w-[200px] h-[200px] bg-[#a78bfada] rounded-full blur-3xl opacity-[25%] bottom-[10%] left-0" />
                        <div className="absolute md:w-[400px] md:h-[300px] w-[200px] h-[200px] bg-[#7dd4fcce] rounded-full blur-3xl opacity-[25%] bottom-[10%] left-20" />
                    </div>
                </div>
                ...
                <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
                    <div className="relative w-full h-full animate-glow-bottom">
                        <div className="absolute md:w-[400px] md:h-[300px] w-[200px] h-[200px] bg-[#a78bface] rounded-full blur-3xl opacity-[25%] top-[10%] right-0" />
                        <div className="absolute md:w-[400px] md:h-[300px] w-[200px] h-[200px] bg-[#7dd4fcd9] rounded-full blur-3xl opacity-[25%] top-[10%] right-20" />
                    </div>
                </div>
