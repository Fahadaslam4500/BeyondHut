            ...
            <div className='relative  max-lg:min-h-[50vh] min-h-[450px] p-5  flex flex-col justify-center items-center md:rounded-[50px] rounded-[30px] overflow-visible'>
                ...
                <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
                    <div className="relative w-full h-full glow-animation">
                        <div className="absolute md:w-[300px] md:h-[200px] w-[200px] h-[200px] bg-[#a78bfada] rounded-full blur-3xl opacity-[25%] bottom-[10%] left-0" />
                        <div className="absolute md:w-[300px] md:h-[200px] w-[200px] h-[200px] bg-[#7dd4fcce] rounded-full blur-3xl opacity-[25%] bottom-[10%] left-20" />
                    </div>
                </div>
                ...
                <div className="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
                    <div className="relative w-full h-full glow-animation">
                        <div className="absolute md:w-[300px] md:h-[300px] w-[200px] h-[200px] bg-[#a78bface] rounded-full blur-3xl opacity-[25%] top-[10%] right-[60%]" />
                        <div className="absolute md:w-[300px] md:h-[300px] w-[200px] h-[200px] bg-[#7dd4fcd9] rounded-full blur-3xl opacity-[25%] top-[10%] right-[60%]" />
                    </div>
                </div>
