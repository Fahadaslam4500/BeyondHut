            ...
            <div className='    max-lg:min-h-[60vh]  md:px-12 md:py-10 md:p-8 p-1 pb-10  flex flex-col justify-center items-center  overflow-hidden '>
                ...
                <div className='w-full md:max-w-[70%] mt-4 mb-4'>
                    <FadeInTop once={false} duration={0.6} distance={30}>
                        <h2 className="font-dm_serif text-2xl md:text-4xl font-thin text-center mb-3">BeyondFlow:  5‑Step Launch Path</h2>
                    </FadeInTop>
                ...
                <div className='flex flex-row justify-around items-center w-full'>
                    <div className='flex flex-col justify-start items-start px-2'>
                        <h4 className='text-xl md:text-2xl font-dm_serif'> Discovery Call</h4>
                ...
                <div className='flex flex-row-reverse justify-around items-center w-full gap-1 px-2'>
                    <div className='flex flex-col justify-start items-start'>
                        <h4 className='text-xl md:text-2xl font-dm_serif'>Talent Shortlist</h4>
                ...
                <div className='flex flex-row md:justify-around justify-center items-center w-full gap-1 px-2'>
                    <div className='flex flex-col justify-start items-start'>
                        <h4 className='text-xl md:text-2xl font-dm_serif'>Interview & Select</h4>
                ...
                <div className='flex flex-row-reverse justify-around items-center w-full gap-1 px-2'>
                    <div className='flex flex-col justify-start items-start'>
                        <h4 className='text-xl md:text-2xl font-dm_serif'> Launch & Integrate</h4>
                ...
                <div className='flex flex-row md:justify-around justify-center items-center w-full gap-1 px-2'>
                    <div className='flex flex-col justify-start items-start'>
                        <h4 className='text-xl md:text-2xl font-dm_serif'>Ongoing Management</h4>
