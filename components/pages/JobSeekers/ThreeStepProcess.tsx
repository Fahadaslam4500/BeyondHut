        ...
        <div className='my-14 py-14 bg-[#F6F6F6]  max-lg:min-h-[50vh] relative'>
            <div className='container'>
                ...
                <div className=' md:px-16 md:py-10 p-5  max-lg:min-h-[60vh] flex flex-col justify-center items-center relative overflow-hidden'>
                   ...
                   <div className='flex flex-col justify-center items-center p-5 mt-4'>
                        <div className='flex flex-col sm:flex-row justify-center items-center gap-3'>
                            <Link href={'/get-started'}>
                                <Button size={'lg'} className="bg-primary hover:bg-primarylight hover:scale-105 rounded-full transition-transform duration-300 ease-in-out transform shadow-md">
                                    Get Hired <MoveRightIcon />
                                </Button>
                            </Link>

                            <a href={'https://calendly.com/fahad-aslam4500'}>
                                <Button size={'lg'} variant={'outline'} className="hover:scale-105 border-2 border-solid border-primary text-primary hover:text-white hover:bg-primary rounded-full transition-transform duration-300 ease-in-out transform shadow-md">
